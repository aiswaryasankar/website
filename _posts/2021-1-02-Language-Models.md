...
<br>
$$h_i^{enc} = [\overrightarrow{h_i^{enc}}; \overleftarrow{h_i^{enc}}]  \text{  where }  {h_i^{enc} \in \mathbb{R}^{2hx1}}$$
<br>

The same for the cell states
<br>
$$c_i^{enc} = [\overrightarrow{c_i^{enc}}; \overleftarrow{c_i^{enc}}]  \text{  where }  {c_i^{enc} \in \mathbb{R}^{2hx1}}$$
<br>
...
<br>
$$h_0^{dec} = W_h[\overrightarrow{h_m^{enc}}; \overleftarrow{h_1^{enc}}] \text{ where } W_h \in \mathbb{R}^{hx2h} $$
<br>
Similarly for the cell states we have
<br>
$$c_0^{dec} = W_c[\overrightarrow{c_m^{enc}}; \overleftarrow{c_1^{enc}}]  \text{ where }  W_c \in \mathbb{R}^{hx2h} $$
<br>
